...
export default {
	data() {
		return {
				...
				remoteConfig: [
					{
						...
						options: [
							...
							},
							{
								...
								value:
									"https://raw.githubusercontent.com/WC-Dream/ACL4SSR/master/Clash/config/ACL4SSR_Mini_Dream.ini",
							},
							{
			...
			form: {
				...
				customBackendAddress: "http://tz.ultrasamscai.com:32425/sub?",
			},
	...
	methods: {
		...
		makeUrl() {
			...
			let backend = this.form.customBackendAddress;
